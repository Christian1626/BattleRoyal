// My module
function MyObject (map_size,room_min_size,room_max_size,room_min_count,room_max_count) {
    this.map = null;
...
MyObject.prototype.FindClosestRoom = function (room) {
    var mid = {
        x: room.x + (room.w / 2),
        y: room.y + (room.h / 2)
    };
...
MyObject.prototype.SquashRooms = function () {
    for (var i = 0; i < 10; i++) {
...
MyObject.prototype.DoesCollide = function (room, ignore) {
    for (var i = 0; i < this.rooms.length; i++) {
